...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, "body{font-family:\"IBM Plex Mono\",monospace}.white{color:#fff}.black{color:#000}.blue{color:#234ef3}.blue-bg{background:linear-gradient(105.1deg,#001f94 -.11%,#1a3fcf 77.87%)}.box-shadow{box-shadow:0 0 5px #000}p{font-weight:400;font-size:20px;line-height:170%;letter-spacing:.04em}.container{max-width:1200px;margin:0 auto}.row{display:flex;width:100%}.col-100{max-width:100%;flex:0 0 100%}.col-55{max-width:55%;flex:0 0 55%}.col-45{max-width:45%;flex:0 0 45%}.middle-align{margin:auto;height:100%;display:flex;flex-direction:column}.primary{font-style:normal;font-weight:600;font-size:30px;line-height:39px;letter-spacing:.02em}.bottom-border-black{border-bottom:6px solid #000}.bottom-border-black,.bottom-border-blue{width:-webkit-max-content;width:-moz-max-content;width:max-content}.bottom-border-blue{border-bottom:6px solid #234ef3}.bottom-border-white{border-bottom:6px solid #fff;width:-webkit-max-content;width:-moz-max-content;width:max-content}.spc-border-bottom{padding-bottom:20px}.spc-border-top{margin-top:30px}.padding-50{padding:50px 0}.margin-top{margin-top:-100px}.row-spc-top{margin-top:5rem}.row-spc-bottom{margin-bottom:5rem}.card-wrapper{display:flex;flex-wrap:wrap;margin-left:-1rem}.card{flex:0 0 360px;max-width:360px;background:#c4c4c4;min-height:360px;margin:1rem}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
const _59dd9a84 = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 2).then(__webpack_require__.bind(null, 30)));
...
const components = {
  Logo: () => __webpack_require__.e(/* import() | components/logo */ 1).then(__webpack_require__.bind(null, 31)).then(c => wrapFunctional(c.default || c))
};
